...
// Generated 06.10.2014 17:11:29 by Hibernate Tools 3.4.0.CR1
 ...
 * @see bobamrz.hajusVahe.generated.Catalog
 * @author Hibernate Tools
 */
public class CatalogHome {

	private static final Log log = LogFactory.getLog(CatalogHome.class);
	...
	public void persist(Catalog transientInstance) {
		log.debug("persisting Catalog instance");
		try {
	...
	public Catalog merge(Catalog detachedInstance) {
		...
		try {
			Catalog result = (Catalog) sessionFactory.getCurrentSession()
	...
	public Catalog findById(int id) {
		...
		try {
			Catalog instance = (Catalog) sessionFactory.getCurrentSession()
					.get("bobamrz.hajusVahe.generated.Catalog", id);
			if (instance == null) {
	...
	public List findByExample(Catalog instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("bobamrz.hajusVahe.generated.Catalog")
